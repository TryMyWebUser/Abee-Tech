                        ...
                        <div class="col-lg-6">
                            <div class="reliable-one__content">
                                <div class="sec-title sec-title--border">
                                    ...
                                    <h3 class="sec-title__title">ABEE TECH PROFILE – UNIT I <br>DIE AND PATTERN MAKING UNIT</h3>
                                    <!-- /.sec-title__title -->
                                </div>
                                <!-- /.sec-title -->

                                <p class="reliable-one__text">
                                We make gravity and pressure die casting dies and patterns for automotive and engineering applications. We have been applying practical solutions using advanced engineering and manufacturing techniques to deliver maximum reliability and productivity. <br><br />Our in-house design and complete manufacturing facility have more than 20 years of experience, especially in medical equipment, valves, automobiles, railways, compressors, and pump components.
                                </p>
                                <!-- /.reliable-one__text -->
                        ...
                        <div class="col-lg-6 wow fadeInRight" data-wow-duration="1500ms">
                            <div class="reliable-one__images">
                                <div class="reliable-one__image">
                                    <img src="assets/images/reliable/reliable-1-3.jpg" alt="reliable" class="reliable-one__image__one" />
                                    <div class="reliable-one__image__inner">
                                        <img src="assets/images/reliable/reliable-1-4.jpg" alt="reliable" class="reliable-one__image__two" />
                                    </div>
